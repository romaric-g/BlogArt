    ...
    <table class="table">
        ...
        <tbody>
            <?php foreach($articles as $article){ ?>
                <tr>
                    <td><?= $article->LibTitrA ?></td>
                    <td><?= $article->DtCreA ?></td>
                    <td><?= $article->Likes ?></td>
                    <td>
                        <a href="delete.php?id=<?= $article->NumArt ?>" class="btn btn-danger">Supprimer</a>
                        <a href="update.php?id=<?= $article->NumArt ?>" class="btn btn-info">Update</a>
                    </td>
                </tr>
            <?php } ?> 
        </tbody>
