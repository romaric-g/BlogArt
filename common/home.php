...
function HOME__($LANG, $USER, $LANGUAGE, $ROOTPATH, $conn){
?>
    <div style="position: absolute; height: 0; width: 0; overflow: hidden">
        ...
        <svg><defs>
            <clipPath id="topbar" clipPathUnits="objectBoundingBox"><path d="M0,0 H1 V0.88 C0.622,1,0.404,1,0,0.887"></path></clipPath>
        </defs></svg>
    </div>
    <header class="container-fluid">
        <div class="row justify-content-end">
            <div class="header-left col-12 col-sm-3 col-md-4" id="header">
                ...
                <div class="content">
                    ...
                    <script>
                        ...
                        function getBubble() {
                            ...
                            let property = bubblesProperties[0];
                            if(r < 40)property = bubblesProperties[1];
                        ...
                        window.getBubble = getBubble;

                        setInterval(function() {
                            if(Math.floor(Math.random() * 100) < probNewBubble)bubbles++;
                        }, 10);
                ...
                <?php NAV($LANG, $USER, $LANGUAGE, $ROOTPATH, $conn) ?>
                <script>
